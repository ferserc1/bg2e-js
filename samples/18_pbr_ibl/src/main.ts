...
import SkyCube from "bg2e-js/ts/render/SkyCube.js";
...
class MyAppController extends AppController {
    ...
    protected _plistRenderers: { plistRenderer: any; materialRenderer: any; transform: Mat4 }[] = [];
    ...
    protected _opaquePipeline: Pipeline | null = null;
    protected _transparentPipeline: Pipeline | null = null;
